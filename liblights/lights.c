        ...
        struct light_state_t const* state)
{
    ...
    err = write_int("/sys/class/backlight/eeepc/brightness", brightness>>4); // eeepc brightness range: 0 - 15
    LOGI("set_light_backlight brightness=%d, brightness>>4 = %d\n", brightness, brightness>>4);
